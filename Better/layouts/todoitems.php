<div class="row px-3 align-items-center todo-item rounded">
                ...
                <div class="row px-3 align-items-center todo-item editing rounded">
                    ...
                    <div class="col px-1 m-1 d-flex align-items-center">
                        <input type="text" class="form-control form-control-lg border-0 edit-todo-input bg-transparent rounded px-3 d-none" value="Sign up for online course" title="Sign up for online course" />
